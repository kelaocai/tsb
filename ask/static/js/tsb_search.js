...
$(document).ready(function()
{
	...
	$('#search_result_more').click(function()
	{
		...
		var request_url = G_BASE_URL + '/tsbm/ajax/search_result/search_type-' +  window.location.hash.replace(/#/g, '') + '__q-' + encodeURIComponent(search_query) + '__template-' + ajax_template + '__page-' + cur_page;
